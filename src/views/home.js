      ...
      <div data-role="Header" className="home-navbar-container">
        <div className="home-navbar">
          ...
          <div className="home-links-container">
            <span className="home-link Anchor">features</span>
          ...
          <div data-role="MobileMenu" className="home-mobile-menu">
            ...
            <div className="home-mid">
              <div className="home-links-container1">
                <span className="home-link4 Anchor">features</span>
      ...
      <div className="home-hero">
        <div className="home-hero-text-container">
          ...
          <span className="home-text02">
            <span>
              Agar ekonomi kita berkembang, kita perlu berinvestasi di proyek
              pertambangan lokal. Salah satu hal terpenting yang mungkin tidak
              diketahui banyak orang adalah bahwa pertambangan adalah bagian
              utama dari perekonomian kita dan bagaimana kita dapat
              memperdagangkan barang dan jasa dengan negara lain.
            </span>
            <br></br>
            ...
            <span>
              Pertambangan adalah industri penting untuk produksi industri,
              namun industri pertambangan terancam oleh peraturan pertambangan.
              Kami membantu perusahaan pertambangan melindungi investasi mereka
              dalam proyek pertambangan. Untuk melakukannya, kami memberi mereka
              informasi dan sumber daya yang diperlukan untuk memastikan bahwa
              mereka mematuhi peraturan terbaru.
            </span>
          </span>
        ...
        <img
          alt="image"
          src="/playground_assets/dall%C2%B7e%202022-12-14%2000.01.10%20-%20artisan%20mining%20-1500w.png"
        ...
        <div className="home-content-container">
          ...
          <div className="home-locations-container">
            <div className="home-location-1">
              <span className="home-heading1">London Office</span>
            ...
            <div className="home-location-2">
              <span className="home-heading2">New York Office</span>
